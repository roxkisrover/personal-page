...
export default function preactPlugin(_a) {
    var _b = _a === void 0 ? {} : _a, devtoolsInProd = _b.devtoolsInProd, include = _b.include, exclude = _b.exclude;
    var config;
    var shouldTransform = createFilter(include || [/\.[tj]sx?$/], exclude || [/node_modules/]);
    var jsxPlugin = {
        ...
        load: function (id) {
            if (id === "preact/jsx-runtime") {
                var runtimePath = resolve.sync("preact/jsx-runtime", {
                    basedir: config.root
                });
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, transformAsync(code, {
                                    babelrc: false,
                                    configFile: false,
                                    ast: true,
                                    root: config.root,
    ...
    return [
        ...
        jsxPlugin,
        preactDevtoolsPlugin({ injectInProd: devtoolsInProd, shouldTransform: shouldTransform }),
        prefresh({ include: include, exclude: exclude }),
    ];
}
